/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages\cloud-sync\wrangler.jsonc packages\cloud-sync\worker-configuration.d.ts` (hash: ae9995441259ef40b6aadd5d3043cc9e)
// Runtime types generated with workerd@1.20260701.1 2025-04-29 
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "https://going-dutch.ducpm1.io.vn,https://going-dutch.pages.dev";
	SYNC_ROOMS: DurableObjectNamespace<import("./src/index").GroupSyncRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GroupSyncRoom";
	}
